...
public class InputHandler {
    ...
    private void menuBeers() {
        ...
        currentImpl.displayEntries("com.dimmbar.Beer");
        exitMethod();
    }

    private void menuSnacks() throws InterruptedException {
        System.out.println("Menu -> Snacks");
        currentImpl.displayEntries("com.dimmbar.Snack");
        pause();
        exitMethod();
    }
    ...
    private void menuDrinks() throws InterruptedException {
        ...
        currentImpl.displayEntries("com.dimmbar.Drink");
        pause();
        exitMethod();
    }
        ...
        while (!input.equals("exit")) {
            ...
            String display =
                    "Stock Manager menu (select option by number) \n" +
                            "1 -> Check Tables \n" +
                            "2 -> Add com.dimmbar.Entry \n" +
                            "3 -> Update com.dimmbar.Entry \n" +
                            "4 -> Delete com.dimmbar.Entry \n" +
                            "5 -> Empty Table \n" +
                            "6 -> Back \n";
            ...
            switch (input) {
                case "1":
                    ...
                    break;
                case "2":
                    // Add com.dimmbar.Entry
                    stockManAddEntry();
                    break;
                case "3":
                    // Update com.dimmbar.Entry
                    stockManUpdateEntry();
                    break;
                case "4":
                    // Delete com.dimmbar.Entry
                    stockManDeleteEntry();
                    break;
                case "5":
                    // Delete by subtype
    ...
    private void stockManAddEntry() throws InterruptedException {
        ...
        while (!input.equals("exit")) {
            Scanner scanner = new Scanner(System.in);
            String display =
                    "Add com.dimmbar.Entry menu (select option by number) \n" +
                            "1 -> Add com.dimmbar.Beer \n" +
                            "2 -> Add com.dimmbar.Drink \n" +
                            "3 -> Add com.dimmbar.Snack \n" +
                            "4 -> Back \n";
...
//                    currentImpl.refreshStock(false);
    ...
    private void stockManUpdateEntry() throws InterruptedException {
        ...
        while (!input.equals("exit")) {
            Scanner scanner = new Scanner(System.in);
            String display =
                    "Update com.dimmbar.Entry menu (select option by number) \n" +
                            "1 -> Update com.dimmbar.Beer \n" +
                            "2 -> Update com.dimmbar.Drink \n" +
                            "3 -> Update com.dimmbar.Snack \n" +
                            "4 -> Back \n";
...
//                    currentImpl.refreshStock();
    ...
    private void stockManDeleteEntry() throws InterruptedException {
        ...
        while (!input.equals("exit")) {
            Scanner scanner = new Scanner(System.in);
            String display =
                    "Delete com.dimmbar.Entry menu (select option by number) \n" +
                            "1 -> Delete com.dimmbar.Beer \n" +
                            "2 -> Delete com.dimmbar.Drink \n" +
                            "3 -> Delete com.dimmbar.Snack \n" +
                            "4 -> Back \n";
            ...
            switch (input) {
                case "1":
                    ...
                    break;
                case "2":
                    // Delete com.dimmbar.Drink entry
                    deleteEntrySubroutine("Drinks", "drink_id");
                    currentImpl.refreshStock(false);
                    break;
                case "3":
                    // Delete com.dimmbar.Snack entry
        ...
        while (!input.equals("exit")) {
            ...
            String display =
                    "Select Table to clear (select option by number) \n" +
                            "1 -> Clear com.dimmbar.Beer \n" +
                            "2 -> Clear com.dimmbar.Drink \n" +
                            "3 -> Clear com.dimmbar.Snack \n" +
                            "4 -> Back \n";
